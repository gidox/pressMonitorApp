...
import { PixelRatio, StyleSheet, View, PanResponder, Animated, TouchableOpacity } from 'react-native';
import { Text } from 'react-native-paper';
import i18n from '../translations/i18n';

const REACTIONS = [
  { label: i18n.t('worried'), src: require('../../assets/worried.png'), bigSrc: require('../../assets/worried_big.png') },
  { label: i18n.t('sad'), src: require('../../assets/sad.png'), bigSrc: require('../../assets/sad_big.png') },
  { label: i18n.t('strong'), src: require('../../assets/ambitious.png'), bigSrc: require('../../assets/ambitious_big.png') },
  { label: i18n.t('happy'), src: require('../../assets/smile.png'), bigSrc: require('../../assets/smile_big.png') },
  { label: i18n.t('surprised'), src: require('../../assets/surprised.png'), bigSrc: require('../../assets/surprised_big.png') },
];
const WIDTH = 320;
